...
export const EMAIL_SIGNATURES: EmailSignature[] = [
  { id: 'classic', name: 'Classique', style: 'minimal', html: `<div style="font-family:Arial;font-size:13px;color:#333;border-top:2px solid #E50914;padding-top:12px;margin-top:20px"><strong style="color:#1A1A2E">{name}</strong><br/><span style="color:#666">{title} — CineGeny</span><br/><span style="color:#999;font-size:11px">{email} | {phone}</span><br/><a href="https://cinegen.com" style="color:#E50914;font-size:11px">cinegen.com</a></div>` },
  { id: 'modern', name: 'Moderne', style: 'bold', html: `<table style="font-family:Arial;font-size:13px"><tr><td style="border-right:3px solid #E50914;padding-right:15px"><strong style="font-size:16px;color:#1A1A2E">{name}</strong><br/><span style="color:#E50914">{title}</span></td><td style="padding-left:15px"><span style="color:#666">CineGeny — Cinéma Participatif IA</span><br/><span style="color:#999;font-size:11px">{email}</span><br/><a href="https://cinegen.com" style="color:#E50914;font-size:11px">cinegen.com</a></td></tr></table>` },
  { id: 'minimal', name: 'Minimaliste', style: 'clean', html: `<div style="font-family:Arial;font-size:12px;color:#999;margin-top:20px">— {name} | {title} | CineGeny | <a href="https://cinegen.com" style="color:#E50914">cinegen.com</a></div>` },
]
