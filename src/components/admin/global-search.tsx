...
const ADMIN_ROUTES: SearchResult[] = [
  ...
  { title: 'Financial', description: 'Detailed financial KPIs', href: '/admin/financial', icon: CreditCard, category: 'Finance' },
  ...
  { title: 'Agents', description: 'AI film agents', href: '/agents', icon: Bot, category: 'Platform' },
  { title: 'Chat', description: 'Chat avec agents IA', href: '/chat', icon: MessageSquare, category: 'Platform' },
  { title: 'Credits / Wallet', description: 'Credit management', href: '/credits', icon: CreditCard, category: 'Platform' },
  ...
  { title: 'Tasks', description: 'Task management', href: '/admin/tasks', icon: Activity, category: 'Dashboard' },
  { title: 'Screenplays', description: 'Review screenplays', href: '/admin/screenplays', icon: Film, category: 'Dashboard' },
  { title: 'Settings', description: 'Admin settings', href: '/admin/settings', icon: Settings, category: 'System' },
  ...
  { title: 'Reputation', description: 'Reputation management', href: '/admin/reputation', icon: Shield, category: 'Dashboard' },
  { title: 'Legal', description: 'Legal compliance', href: '/admin/legal', icon: Shield, category: 'System' },
