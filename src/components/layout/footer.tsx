        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-14">
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <ul className="space-y-3.5">
              ...
              <li><Link href="/vote" className="group flex items-center gap-2 text-[13px] text-white/25 hover:text-[#E50914] transition-colors"><Vote className="h-3.5 w-3.5 opacity-40 group-hover:opacity-100 transition-opacity" />Vote</Link></li>
              <li><Link href="/academy" className="group flex items-center gap-2 text-[13px] text-white/25 hover:text-[#E50914] transition-colors"><GraduationCap className="h-3.5 w-3.5 opacity-40 group-hover:opacity-100 transition-opacity" />Academy</Link></li>
          ...
          <div className="lg:col-span-3 space-y-5">
            ...
            <ul className="space-y-3.5">
              ...
              <li><Link href="/participate" className="group flex items-center gap-2 text-[13px] text-white/25 hover:text-[#E50914] transition-colors"><Sparkles className="h-3.5 w-3.5 opacity-40 group-hover:opacity-100 transition-opacity" />Participate</Link></li>
