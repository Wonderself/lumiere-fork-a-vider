...
const INIT_INSTITUTIONS: Institution[] = [
  ...
  {id:"i-eden-list",name:"Liste Angels d'Eden Shochat (500+)",cat:"Angel Israel",type:"Angel investor database",focus:"500+ Israeli angels, all sectors",stage:"Pre-Seed → Seed",ticket:"$25K-500K individuel",url:"https://github.com/AdenShohat/Israeli-Angel-Investors",contact:"GitHub public — liste avec emails/LinkedIn",what_to_send:"Short email + attached deck. Personalize each approach.",why:"THE reference. 500+ contacts with detailed investment preferences.",status:"todo"},
