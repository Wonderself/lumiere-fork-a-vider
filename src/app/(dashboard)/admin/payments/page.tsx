    ...
    <div className="space-y-10">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {[
          ...
          { icon: CreditCard, label: 'Total distributed', value: formatPrice(totalCompleted + totalPending), sub: 'all methods', color: 'text-[#E50914]' },
          { icon: AlertCircle, label: 'Moy. par paiement', value: formatPrice(countCompleted > 0 ? totalCompleted / countCompleted : 0), sub: 'completed payments', color: 'text-blue-600' },
        ].map((s) => (
