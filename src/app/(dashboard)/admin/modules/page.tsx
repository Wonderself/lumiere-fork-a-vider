    ...
    <div className="space-y-8">
      ...
      <div className="flex gap-3">
        <div className="relative flex-1">
          ...
          <input value={search} onChange={e => setSearch(e.target.value)} placeholder="Search..." className="w-full pl-10 pr-4 py-2 rounded-lg border border-white/10 text-sm focus:border-[#E50914] focus:outline-none" />
        </div>
