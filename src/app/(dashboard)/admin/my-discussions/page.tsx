...
const TEMPLATES: DiscussionTemplate[] = [
  ...
  { id: 'hr', name: 'Team & HR', icon: Users, color: '#F59E0B', agent: 'cg-community-manager', systemPrompt: 'You are an HR director expert in creative recruiting.', starters: ['Premiers recrutements', 'Culture d\'entreprise', 'Compensation plan'] },
