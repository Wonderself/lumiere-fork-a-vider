    ...
    <div className="min-h-screen bg-[#0A0A0A]">
      <div className="max-w-5xl mx-auto px-4 py-16">
        <div className="text-center mb-16">
          ...
          <h1 className="text-4xl font-bold text-white font-[family-name:var(--font-playfair)] mb-4">Agents IA <span className="text-[#E50914]">Cinema</span></h1>
          <p className="text-lg text-gray-400 max-w-2xl mx-auto">A full team of AI experts covering every film craft, from screenplay to distribution.</p>
        </div>
