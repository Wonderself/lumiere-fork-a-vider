...
export default function PosterMakerPage() {
  ...
  async function generate() {
    ...
    setGenerating(false)
    toast.success('Poster generated by AI Poster Artist!')
  }
          ...
          <div className="space-y-6">
            <div className="rounded-2xl border border-gray-800 bg-gray-900/50 p-6 space-y-5">
              ...
              <div>
                ...
                <input value={tagline} onChange={e => setTagline(e.target.value)} placeholder="e.g. The truth has a price..." className="w-full rounded-xl border border-gray-700 bg-gray-800 px-4 py-2.5 text-sm text-white placeholder-gray-500 focus:border-[#E50914] focus:outline-none" />
              </div>
            </div>
